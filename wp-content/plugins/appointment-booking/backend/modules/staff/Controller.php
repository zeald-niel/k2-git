...
class Controller extends Lib\Base\Controller
{
    ...
    public function index()
    {
        ...
        $this->enqueueScripts( array(
            ...
            'module' => array(
                ...
                'js/staff.js'          => array( 'jquery-ui-sortable', 'jquery-ui-datepicker', 'bookly-range_tools.js', 'bookly-staff-services.js' ),
            ),
        ) );
    ...
    public function executeDeleteStaff()
    {
        ...
        if ( $this->isCsrfTokenValid() && Lib\Utils\Common::isCurrentUserAdmin() ) {
