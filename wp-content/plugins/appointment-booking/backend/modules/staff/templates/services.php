                ...
                <div class="panel panel-default bookly-panel-unborder">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="<?php echo \Bookly\Lib\Proxy\Shared::prepareStaffServiceLabelClass( 'col-md-3' ) ?> hidden-xs hidden-sm text-right">
                            ...
                            <div class="<?php echo \Bookly\Lib\Proxy\Shared::prepareStaffServiceLabelClass( 'col-md-3' ) ?> hidden-xs hidden-sm">
                        ...
                        <?php foreach ( $uncategorized_services as $service ) : ?>
                            <li class="list-group-item">
                                <div class="row">
                                    ...
                                    <div class="<?php echo \Bookly\Lib\Proxy\Shared::prepareStaffServiceInputClass( 'col-xs-7 col-md-3' ) ?>">
                                    ...
                                    <div class="<?php echo \Bookly\Lib\Proxy\Shared::prepareStaffServiceInputClass( 'col-xs-5 col-md-3' ) ?>">
                                        <div class="bookly-font-smaller bookly-margin-bottom-xs bookly-color-gray visible-xs visible-sm">
                                            <?php _e( 'Capacity', 'bookly' ) ?>
                                        </div>
                                ...
                                <?php \Bookly\Lib\Proxy\Shared::renderStaffServiceTail( $staff_id, $service['id'] ) ?>
                            </li>
                        <?php endforeach ?>
                    </ul>
                </div>
                    ...
                    <div class="panel panel-default bookly-panel-unborder">
                        <div class="panel-heading bookly-services-category">
                            <div class="row">
                                ...
                                <div class="<?php echo \Bookly\Lib\Proxy\Shared::prepareStaffServiceLabelClass( 'col-xs-7 col-md-3' )?> hidden-xs hidden-sm text-right">
                                    <div class="bookly-font-smaller bookly-color-gray"><?php _e( 'Price', 'bookly' ) ?></div>
                                </div>

                                <?php \Bookly\Lib\Proxy\DepositPayments::renderStaffServiceLabel() ?>

                                <div class="<?php echo \Bookly\Lib\Proxy\Shared::prepareStaffServiceLabelClass( 'col-xs-5 col-md-3' ) ?> hidden-xs hidden-sm">
                            ...
                            <?php foreach ( $category->getServices() as $service ) : ?>
                                <li class="list-group-item">
                                    <div class="row">
                                        ...
                                        <div class="<?php echo \Bookly\Lib\Proxy\Shared::prepareStaffServiceInputClass( 'col-xs-7 col-sm-3' ) ?>">
                                            <div class="bookly-font-smaller bookly-margin-bottom-xs bookly-color-gray visible-xs visible-sm">
                                                <?php _e( 'Price', 'bookly' ) ?>
                                            </div>
                                        ...
                                        <div class="<?php echo \Bookly\Lib\Proxy\Shared::prepareStaffServiceInputClass( 'col-xs-5 col-sm-2' ) ?>">
                                            <div class="bookly-font-smaller bookly-margin-bottom-xs bookly-color-gray visible-xs visible-sm">
                                                <?php _e( 'Capacity', 'bookly' ) ?>
                                            </div>
                                    ...
                                    <?php \Bookly\Lib\Proxy\Shared::renderStaffServiceTail( $staff_id, $service->get( 'id' ) ) ?>
                                </li>
                            <?php endforeach ?>
                        </ul>
                    </div>
